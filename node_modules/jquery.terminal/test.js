...
(function () {
    ...
    // :: enabled
    // -------------------------------------------------------------------------
    test_type(term.enabled());
    // -------------------------------------------------------------------------
    // :: signature
    // -------------------------------------------------------------------------
    test_type(term.signature());
    // -------------------------------------------------------------------------
    // :: version
    // -------------------------------------------------------------------------
    test_type(term.version());
    // -------------------------------------------------------------------------
    // :: cmd
    // -------------------------------------------------------------------------
    test_type(term.cmd());
    ...
    // :: get_position
    // -------------------------------------------------------------------------
    test_type(term.get_position());
    // -------------------------------------------------------------------------
    // :: insert
    // -------------------------------------------------------------------------
    test_type(term.insert("foo"));
    term.insert("foo", true);
    // -------------------------------------------------------------------------
    // :: set_prompt
    // -------------------------------------------------------------------------
    test_type(term.set_prompt(">>> "));
    ...
    // :: get_prompt
    // -------------------------------------------------------------------------
    var fn = term.get_prompt();
    var prompt = term.get_prompt();
    // -------------------------------------------------------------------------
    // :: set_mask
    // -------------------------------------------------------------------------
    test_type(term.set_mask(true));
    term.set_mask("-");
    // -------------------------------------------------------------------------
    // :: get_output
    // -------------------------------------------------------------------------
    test_type(term.get_output());
    var lines = term.get_output();
    test_type(lines[0].index);
    var div = $('<div/>');
    ...
    // :: resize
    // -------------------------------------------------------------------------
    test_type(term.resize());
    term.resize(100);
    term.resize(100, 200);
    // -------------------------------------------------------------------------
    // :: refresh
    // -------------------------------------------------------------------------
    test_type(term.refresh());
    // -------------------------------------------------------------------------
    // :: flush
    // -------------------------------------------------------------------------
    test_type(term.flush());
    term.flush({ update: true });
    term.flush({ scroll: true });
    // -------------------------------------------------------------------------
    // :: update
    // -------------------------------------------------------------------------
    test_type(term.update(10, ">>>"));
    term.update(10, ">>>", {
    ...
    term.echo(Promise.resolve(["foo"]));
    term.echo(Promise.resolve(function () {
        return "foo";
    }));
    term.echo(Promise.resolve(function () {
        return ["foo"];
    ...
    test_type(term.exception(e));
    term.exception(e, "ERROR");
    // -------------------------------------------------------------------------
    // :: scroll
    // -------------------------------------------------------------------------
    test_type(term.scroll(10));
    // -------------------------------------------------------------------------
    // :: logout
    // -------------------------------------------------------------------------
    test_type(term.logout());
    term.logout(true);
    // -------------------------------------------------------------------------
    // :: token
    // -------------------------------------------------------------------------
    test_type(term.token());
    term.token(true);
    // -------------------------------------------------------------------------
    // :: set_token
    // -------------------------------------------------------------------------
    test_type(term.set_token("foo"));
    term.set_token("foo", true);
    // -------------------------------------------------------------------------
    // :: get_token
    // -------------------------------------------------------------------------
    test_type(term.get_token());
    term.get_token(true);
    // -------------------------------------------------------------------------
    // :: login_name
    // -------------------------------------------------------------------------
    test_type(term.login_name());
    ...
    // :: prefix_name
    // -------------------------------------------------------------------------
    test_type(term.prefix_name());
    test_type(term.prefix_name(true));
    // -------------------------------------------------------------------------
    // :: read
    // -------------------------------------------------------------------------
    ...
    // :: invoke_key
    // -------------------------------------------------------------------------
    test_type(term.invoke_key("CTRL+C"));
    // -------------------------------------------------------------------------
    // :: keymap
    // -------------------------------------------------------------------------
    var keymap_fn = term.keymap('CTRL+K');
    ...
    // :: level
    // -------------------------------------------------------------------------
    test_type(term.level());
    // -------------------------------------------------------------------------
    // :: reset
    // -------------------------------------------------------------------------
    test_type(term.reset());
    // -------------------------------------------------------------------------
    // :: purge
    // -------------------------------------------------------------------------
    test_type(term.purge());
    // -------------------------------------------------------------------------
    // :: destroy
    // -------------------------------------------------------------------------
    test_type(term.destroy());
    // -------------------------------------------------------------------------
    // :: scroll_to_bottom
    // -------------------------------------------------------------------------
    test_type(term.scroll_to_bottom());
    // -------------------------------------------------------------------------
    // :: is_bottom
    // -------------------------------------------------------------------------
    test_type(term.is_bottom());
});
// -----------------------------------------------------------------------------
// :: CMD
// -----------------------------------------------------------------------------
...
(function () {
    ...
    // :: option
    // -------------------------------------------------------------------------
    test_type(cmd.option("mask", 10));
    test_type(cmd.option("mask"));
    // -------------------------------------------------------------------------
    // :: name
    // -------------------------------------------------------------------------
    test_type(cmd.name());
    test_type(cmd.name("foo"));
    // -------------------------------------------------------------------------
    // :: purge
    // -------------------------------------------------------------------------
    test_type(cmd.purge());
    ...
    // :: history
    // -------------------------------------------------------------------------
    test_type(cmd.history());
    cmd.history().next();
    // -------------------------------------------------------------------------
    // :: delete
    // -------------------------------------------------------------------------
    test_type(cmd.delete(10));
    test_type(cmd.delete(10, true));
    // -------------------------------------------------------------------------
    // :: set
    // -------------------------------------------------------------------------
    test_type(cmd.set("foo"));
    test_type(cmd.set("foo", true));
    test_type(cmd.set("foo", true, true));
    // -------------------------------------------------------------------------
    // :: keymap
    // -------------------------------------------------------------------------
    var keymap_fn = cmd.keymap('CTRL+K');
    ...
    // :: insert
    // -------------------------------------------------------------------------
    test_type(cmd.insert("foo"));
    test_type(cmd.insert("foo", true));
    // -------------------------------------------------------------------------
    // :: get
    // -------------------------------------------------------------------------
    test_type(cmd.get());
    ...
    // -------------------------------------------------------------------------
    cmd.commands()("foo");
    test_type(cmd.commands(function (command) {
    ...
    // :: destroy
    // -------------------------------------------------------------------------
    test_type(cmd.destroy());
    // -------------------------------------------------------------------------
    // :: prompt
    // -------------------------------------------------------------------------
    var fn = cmd.prompt();
    var prompt = cmd.prompt();
    test_type(cmd.prompt(function (cb) {
        this.display_position();
        cb(">>> ");
    }));
    test_type(cmd.prompt(">>> "));
    test_type(cmd.prompt(true));
    // -------------------------------------------------------------------------
    // :: position
    // -------------------------------------------------------------------------
    test_type(cmd.position());
    test_type(cmd.position(10));
    test_type(cmd.position(10, true));
    // -------------------------------------------------------------------------
    // :: refresh
    // -------------------------------------------------------------------------
    test_type(cmd.refresh());
    // -------------------------------------------------------------------------
    // :: display_postion
    // -------------------------------------------------------------------------
    test_type(cmd.display_position());
    test_type(cmd.display_position(10));
    // -------------------------------------------------------------------------
    // :: show
    // -------------------------------------------------------------------------
    test_type(cmd.show());
    ...
    // :: resize
    // -------------------------------------------------------------------------
    test_type(cmd.resize());
    test_type(cmd.resize(100));
    // -------------------------------------------------------------------------
    // :: enable
    // -------------------------------------------------------------------------
    test_type(cmd.enable());
    // -------------------------------------------------------------------------
    // :: isenabled
    // -------------------------------------------------------------------------
    test_type(cmd.isenabled());
    // -------------------------------------------------------------------------
    // :: disable
    // -------------------------------------------------------------------------
    test_type(cmd.disable());
    test_type(cmd.disable(true));
    // -------------------------------------------------------------------------
    // :: mask
    // -------------------------------------------------------------------------
    test_type(cmd.mask(true));
    test_type(cmd.mask("-"));
    test_type(cmd.mask());
    test_type(cmd.mask());
});
